...
const {validateCreate} = require('../validators/medicaments.validators');
...
router.post(vs + '/medicaments', validateCreate, medicaments_controller.createMedicamentController);
